...
for fold in ["fold_01", "fold_04", "fold_03", "fold_04", "fold_05"]:
    config = dict()
    # directories
    config["main_folder"] = os.path.abspath("/home/alzbeta/data/Ischemic_stroke_lesion/3DUnet_v2/output/cross_val_01/")
    config["output_foder"] = os.path.join(config["output_foder"], fold) # path to folder where the outputs should be saved
