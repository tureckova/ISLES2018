...
create_convolution_block = partial(create_convolution_block, activation=LeakyReLU, dilation_rate = (1,1,1), instance_normalization=True)
...
def isensee2017_model(input_shape=(4, 128, 128, 128), n_base_filters=16, depth=5, dropout_rate=0.3,
    ...
    :param n_labels:
    :param optimizer: Adam or YellowFin
