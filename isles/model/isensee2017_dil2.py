...
def isensee2017_model_dil2(input_shape=(4, 128, 128, 128), n_base_filters=16, depth=5, dropout_rate=0.3,
    ...
    for level_number in range(depth):
        ...
        if current_layer is inputs:
            in_conv = create_convolution_block(current_layer, n_level_filters, dilation_rate = (2,2,1))
        else:
